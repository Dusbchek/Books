...
export default function CartPage() {
  ...
  return (
    ...
    <div className="flex flex-row  py-3 ml-10 px-3 rounded-md bg-gray-200  border-2 border-gray-300 mb-2 w-[90%]">
      <img
        src={item.image}
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col">
          ...
          <div>
            <div className="h-32 bg-gray-200 w-[90%] rounded-lg border-2 border-gray-300 mt-2">
              <ul>
                <li>
